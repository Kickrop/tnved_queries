select right(period,4) god,'âñåãî' sss,sum(stoim)/1000/1000 "èìïîğò" from 
stat_customs.tcbt
where napr='ÈÌ'
group by right(period,4)
union
select right(period,4) god,'áåç sss' sss,sum(stoim)/1000/1000 from 
stat_customs.tcbt
where napr='ÈÌ' and tnved not like '%SSSSSS%'
group by right(period,4)
union
select right(period,4) god,'sss' sss, sum(stoim)/1000/1000 from 
stat_customs.tcbt
where napr='ÈÌ' and tnved like '%SSSSSS%'
group by right(period,4)
order by god, sss
